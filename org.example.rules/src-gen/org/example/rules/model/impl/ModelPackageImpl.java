...
import org.example.rules.model.ModelFactory;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage
{
   ...
   * @see org.example.rules.model.ModelPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EReference getActionRef_Node()
  {
   ...
   */
  @Override
  public EAttribute getFilter_Element()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(actionRefEClass, ACTION_REF__NODE);

    filterEClass = createEClass(FILTER);
    createEAttribute(filterEClass, FILTER__ELEMENT);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getActionRef_Node(), this.getAction(), null, "node", null, 0, 1, ActionRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(filterEClass, Filter.class, "Filter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFilter_Element(), ecorePackage.getEString(), "element", null, 0, 1, Filter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRule_Filters(), this.getFilter(), null, "filters", null, 0, -1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRule_Actions(), this.getActionRef(), null, "actions", null, 0, -1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
